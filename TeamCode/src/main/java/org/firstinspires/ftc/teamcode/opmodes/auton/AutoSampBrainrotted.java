...
import org.firstinspires.ftc.teamcode.base.commands.SetSlideArmCommand;
...
@Autonomous(name="brainrot ahh auto",group = ".Auton")
public class AutoSampBrainrotted extends OpMode {
    ...
    public enum AutoPaths {
        ...
        GRAB_SAMPLE_2(
                score,
                new Pose(samp2X, 18.5, Math.toRadians(270))
        ),
        GRAB_SAMPLE_2_FINAL(
                new Pose(samp2X, 18.5, Math.toRadians(270)),
        ...
        GRAB_SAMPLE_3(
                score,
                new Pose(-11, 24, Math.toRadians(315))
        ),
        GRAB_SAMPLE_3_FINAL(
                new Pose(-11, 24, Math.toRadians(315)),
    ...
    public void init() {
        ...
        hSlide = new PIDFSingleSlideSubsystem(hardwareMap, Const.hSlide, -0.02, 0, 0.000005, 0.0);
        ...
        Command scoreCommand = new ParallelCommandGroup(
                ...
                new SequentialCommandGroup(
                        ...
                        new WaitCommand(pause, 1500),
                        new SetSlideArmCommand(slide, slide.getF())
                )
        );
        ...
        Command transferCommand = new SequentialCommandGroup(
                ...
                new IntakeAutoCommand(intake, -0.2),
