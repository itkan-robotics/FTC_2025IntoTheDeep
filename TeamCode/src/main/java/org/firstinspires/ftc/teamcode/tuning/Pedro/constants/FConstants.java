...
public class FConstants {
    static {
        ...
        FollowerConstants.mass = 11.3398;

        FollowerConstants.xMovement = 75.3601;
        FollowerConstants.yMovement = 36.3084;

        FollowerConstants.forwardZeroPowerAcceleration = -22.8336;
        FollowerConstants.lateralZeroPowerAcceleration = -54.4427;

        FollowerConstants.translationalPIDFCoefficients.setCoefficients(0.25,0,0.02,0);
        FollowerConstants.useSecondaryTranslationalPID = false;
        FollowerConstants.secondaryTranslationalPIDFCoefficients.setCoefficients(0.1,0,0.01,0); // Not being used, @see useSecondaryTranslationalPID

        FollowerConstants.headingPIDFCoefficients.setCoefficients(1.5,0,0.3,0);
        ...
        FollowerConstants.centripetalScaling = 5e-70;
