...
public class AutoCenter extends OpMode {
    ...
    public void init() {
        ...
        Command[] grabAndScore = {
                grabAndScore(AutoPaths.GRAB_SPECIMEN_1, AutoPaths.SCORE_SPECIMEN_1, AutoPaths.GRAB_FINAL_1, 100),
                grabAndScore(AutoPaths.GRAB_SPECIMEN_2, AutoPaths.SCORE_SPECIMEN_2, AutoPaths.GRAB_FINAL_2, 315),
                grabAndScore(AutoPaths.GRAB_SPECIMEN_3, AutoPaths.SCORE_SPECIMEN_2, AutoPaths.GRAB_FINAL_2, 100),
        };
    ...
    public Command park(){
        return new SequentialCommandGroup(
                ...
                new FollowPathCommand(follower, AutoPaths.GRAB_SPECIMEN_3.curve(follower), true)
        );
    }

    public Command grabAndScore(AutoPaths grab, AutoPaths score, AutoPaths fina, int height) {
        return new SequentialCommandGroup(
                new ParallelCommandGroup(
                        ...
                        new FollowPathCommand(follower, grab.curve(follower), true)
                ),
                new FollowPathCommand(follower, fina.curve(follower), true, .4),
                ...
                new ParallelCommandGroup(
                        ...
                        new FollowPathCommand(follower, score.curve(follower), true)
                )
        );
    }
